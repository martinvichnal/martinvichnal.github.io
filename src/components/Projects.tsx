...
export const projectObj = [
    {
        ...
        description: "This is my first sort of complex React project. This page is based on the pomodoro technique which is an excellent way for time management. It was invented in the late 1980s by Francesco Cirillo.",
        image: pomodoroImage,
        tags: ["React", "WebDev"],
    ...
    },
    {
        ...
        description: "Smart lamp built with ESP32 and WS2812B LEDs. It is controlled by a web interface.",
...
const Projects = ({ title, description, image, tags, webSource, gitSource }: ProjectsProps) => {
    return (
        <div>
            <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href={webSource} target="_blank">
                    <img className="rounded-t-lg object-cover h-48 w-96" src={image} alt="Project image" />
                </a>
                <div className="p-5">
                    <a href={webSource} target="_blank">
    ...
    return (
        <div>
            {tags.map((tag) => {
                ...
                switch (tag) {
                    case 'React':
                        tagClassName = 'bg-blue-100 text-blue-800 text-xs dark:bg-blue-900 dark:text-blue-300';
                        break;
                    case 'WebDev':
                        tagClassName = 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300';
                        break;
                    case 'ESP32':
                        tagClassName = 'bg-green-100 text-green-800 rounded dark:bg-green-900 dark:text-green-300';
                        break;
                    case 'C++':
                        tagClassName = 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300';
                        break;
                    case 'IoT':
                        tagClassName = 'bg-purple-100 text-purple-800 dark:bg-purple-900 dark:text-purple-300';
                        break;
                    default:
                        tagClassName = 'bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-300';
                        break;
                }

                return (
                    <span key={tag} className={`text-xs font-medium mt-4 px-2.5 py-0.5 mx-0.5 rounded ${tagClassName}`}>
                        {tag}
                    </span>
                );
            })}
